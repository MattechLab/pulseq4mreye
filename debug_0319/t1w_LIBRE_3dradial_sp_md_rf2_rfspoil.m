...
grad_mode = 'Fast';
checking = true;
seq_note = 'b1_t1w_LIBRE_3dradial_sp_md_rf2_rfspoil';
add_rfdelay = true;
rfdelay_ratio = 1;
do_compile = 0;
seqfolder = "/Users/cag/Documents/forclone/pulseq4mreye/debug_0319/seqs_0319";
methodrf = 2; 
use_rfspoiler = 1;
...
if use_rfspoiler
    ...
    for indLine = 1:iLine
        ...
        phase_accum2(1) - phase_accum1(end);
...
if plot_rfpulses
    ...
    set(gcf, 'Color', 'w'); 
    subplot(1,3,1);
    plot(angle(rf_spoil_list{1}.signal), 'r-', 'LineWidth', 2); % Phase of processed RF
