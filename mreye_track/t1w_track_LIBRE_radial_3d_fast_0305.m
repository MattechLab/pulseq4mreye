...
% Param
% ----------------------------------------------------------------------------
% TR=8ms TE=3.61ms flip angle 8 deg
% nLines 81906
% nShot = 81906/22 = 3723
% ----------------------------------------------------------------------------
...
grad_mode = 'Fast';
checking = true;
seq_note = 'fast_slew120_81906lines_1rfratio';
add_rfdelay = true;
rfdelay_ratio = 1;
do_compile = true;
%
...
if do_compile
    ...
    seq_name = strcat("YJ_mreyetrack_TR8p01_0p5x0p5x0p5_LIBRE_traj_original_", seq_note);
