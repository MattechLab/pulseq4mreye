...
clear; rmpath(genpath('/Users/cag/Documents/forclone'));
%%
clc;close all;
...
grad_mode = 'Fast';
checking = true;
seq_note = 'a1_main_t1w_LIBRE_rf1_wo_rfspoil';
add_rfdelay = true;
rfdelay_ratio = 1;
do_compile = 1;
seqfolder = "/Users/cag/Documents/forclone/pulseq4mreye/debug_0324/seqs_v14/";
methodrf = 1; 
use_rfspoiler = 1;
...
if use_rfspoiler
    ...
    rf_spoiling_increment = 0; % Spoiling increment in degrees
    rf1_spoil_list = [];
    rf2_spoil_list = [];
    adc_phaseOffset = [];
    for indLine = 1:iLine
