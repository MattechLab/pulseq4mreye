...
for seq_mode = seq_mode_array
    ...
    rfdelay_ratio = 1;
    do_compile = 1;
    seqfolder = "/Users/cag/Documents/forclone/pulseq4mreye/mreye2p0/";
    use_rfspoiler = 1;
    
    %%%%
    seq_mode_list = {'pre', 'main', 'debug'};
    seq_note = strcat('sub',num2str(subject_num),'_',seq_mode_list{seq_mode},'_libre_rfsp_qua',num2str(rf_spoiling_increment), '_adc0_',note_suffix);
