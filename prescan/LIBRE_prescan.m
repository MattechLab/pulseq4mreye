...
grad_mode = 'Fast';
checking = true;
seq_note = 'fast_slew120_9218lines_1rfratio';
add_rfdelay = true;
rfdelay_ratio = 1;
do_compile = true;
%
...
if do_compile
    ...
    seq_name = strcat("YJ_prescan_TR8p01_0p5x0p5x0p5_LIBRE_traj_original_", seq_note);
